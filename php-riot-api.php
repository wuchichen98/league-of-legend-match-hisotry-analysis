...
class riotapi {
	...
	const API_URL_STATIC_3 = 'https://{platform}.api.riotgames.com/lol/static-data/v4/';
	const API_URL_MATCH_3 = 'https://{platform}.api.riotgames.com/lol/match/v4/';
   ...
   // $APIK = 'RGAPI-ab15e94f-d1aa-4324-a939-97b923960f52';
	const API_KEY = 'RGAPI-9f4ee72f-268c-46b5-875a-82773a7dc2ec';
